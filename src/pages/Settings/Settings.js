    ...
    return (
        <div className="settings-page">
            <div className="settings-card">
                ...
                {/* Status Badge */}
                <div className={`settings-status ${hasKey ? 'status-active' : 'status-inactive'}`}>
                    <span className="status-dot"></span>
                    <span>{hasKey ? t('settings-status-active') : t('settings-status-inactive')}</span>
                </div>

                {/* API Key Section */}
                <div className="settings-section">
                    <label className="settings-label">{t('settings-api-label')}</label>
                    <p className="settings-description">{t('settings-api-description')}</p>
                    ...
                    {hasKey && !showKey && (
                        <p className="settings-masked-preview">{maskedKey}</p>
                    )}
                </div>
                ...
                <div className="settings-info-box">
                    ...
                    <div>
                        <p className="settings-info-title">{t('settings-info-title')}</p>
                        <p className="settings-info-text">{t('settings-info-text')}</p>
                        <a
